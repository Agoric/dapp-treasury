...
const useStyles = makeStyles(() => {
  return {
    ...
    '@keyframes jump1': {
      '0%, 40%, 60%': { transform: 'translate3d(24px, 24px, 0)' },
      '16%': { transform: 'translate3d(24px, 24px, 18px)' },
    },
    '@keyframes jump2': {
      '0%, 40%, 100%': { transform: 'translate3d(-24px, 24px, 0)' },
      '16%': { transform: 'translate3d(-24px, 24px, 18px)' },
    },
    '@keyframes jump3': {
      '0%, 40%, 100%': { transform: 'translate3d(24px, -24px, 0)' },
    ...
    shadow: {
      ...
      opacity: 0,
      '&:nth-of-type(2)': {
        transform: 'translate3d(24px, 24px, -1px)',
